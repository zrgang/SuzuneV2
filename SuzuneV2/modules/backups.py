...
import SuzuneV2.modules.sql.notes_sql as sql
from SuzuneV2 import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from SuzuneV2.__main__ import DATA_IMPORT
from SuzuneV2.modules.helper_funcs.chat_status import user_admin
from SuzuneV2.modules.helper_funcs.alternate import typing_action

# from SuzuneV2.modules.rules import get_rules
import SuzuneV2.modules.sql.rules_sql as rulessql

# from SuzuneV2.modules.sql import warns_sql as warnssql
import SuzuneV2.modules.sql.blacklist_sql as blacklistsql
from SuzuneV2.modules.sql import disable_sql as disabledsql

# from SuzuneV2.modules.sql import cust_filters_sql as filtersql
# import SuzuneV2.modules.sql.welcome_sql as welcsql
import SuzuneV2.modules.sql.locks_sql as locksql
from SuzuneV2.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("SuzuneV2{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SuzuneV2{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SuzuneV2-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SuzuneV2{}.backup".format(chat_id))  # Cleaning file
