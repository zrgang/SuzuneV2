...
from SuzuneV2 import BOT_ID
from SuzuneV2.helper_extra.aichat import add_chat, get_session, remove_chat
from SuzuneV2.pyrogramee.pluginshelper import admins_only, edit_or_reply
from SuzuneV2 import pbot as innexia
...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("innexia", "Aco")
        URL = "https://api.affiliateplus.xyz/api/chatbot?message=hi&botname=@SuzuneV2&ownername=@useIes"
        ...
        test = test.replace("innexia", "Aco")
        test = test.replace("innexia", "Aco")
        URL = f"https://api.affiliateplus.xyz/api/chatbot?message={test}&botname=@SuzuneV2&ownername=@useIes"
        try:
            r = requests.request("GET", url=URL)
        except:
            return
